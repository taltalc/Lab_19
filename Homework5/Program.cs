...
namespace Homework5
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
           ...
           foreach (var n in computers)
            {
              Console.WriteLine($" {n.Id} { n.Brand} {n.ProcessorType}  {n.RAMsize} {n.Harddiskspace} {n.Videocardmemory} {n.Cost} {n.Numberofunits}");
            }
